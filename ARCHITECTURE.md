...
Проект разделен на две независимые части: серверную (FastAPI) и клиентскую (PyQt5 + HTTP).
...
│ - Экспорт       │    4. Скачивание结果    │ - Экспорт результатов│
└─────────────────┘                         └─────────────────┘
```
